...
class AStarExplorer:
    ...
    def __init__(self, maze, visualize=False):
        ...
        self.moves = []
        self.backtrack_count = 0  # Not really applicable in A*, but included for stats
    ...
    def solve(self):
        ...
        while open_set:
            ...
            if current == self.goal:
                print(f"✅ Goal reached in {visited_nodes} steps")  # DEBUG
            ...
            if visited_nodes % 500 == 0:
                print(f"🔍 Explored {visited_nodes} nodes...")  # DEBUG
